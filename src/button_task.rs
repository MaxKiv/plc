...
/// Task to debounce a single button
/// pool_size is used as workaround for embassy disallowing generic task arguments, this should be
/// equal to the total amount of buttons in your system
